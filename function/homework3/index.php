...
?>
    <div class="myContent">
        ...
        <div class="text2">
        <?php echo textColor('На данный курс записалась, так как есть материалы которые не входят в программу
                обучения в колледже и начать работать по специальности.<b> Большие надежды на курс!') ?>
