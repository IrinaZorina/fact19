<?php require_once'inc/header.php'?>
    ...
    <div class="main">
        ...
        <div class="container">
            <div class="about">
                <?php
                About("Здравстуйте , меня зовут Горячих Иван. Живу в городе Магнитогорск , ранее учился на программиста , сейчас хочу вспомнить и получить новые знания. В свободное время занимаюсь баскетболом.");
                echo "<br>";
                diff('25.07.1998' , "" , "");
                    ?>
            </div>
            ...
            <div class="lesson">
                <?php
                echo lesson("С 1 урока было все понятно четко и по делу!");
                ?>
            </div>
        </div>
    </div>
        ...
        <div class="container-info">
            <div class="strings">
                <?php
                echo "Количесто слов на странице:" . " ";
