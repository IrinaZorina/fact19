<?php
require __DIR__ . '/mainFunctions.php'; // Подключаем файл с функциями
...
<div class="container">
  <?php
  $dateInfo = calculateDaysDifference('05.10.1991'); // Вычисляем разницу в днях
  echo "<div style='margin-bottom: 20px; text-align: center;'>";
  echo "Дата рождения: " . $dateInfo['birthDate'] . "<br>";
  echo "Текущая дата: " . $dateInfo['currentDate'] . "<br>";
  echo "Разница в днях: " . $dateInfo['days'] . " дня";
  echo "</div>";
  ?>
...
<?php
$vowelCount = countVowelsInBlocks($newText, $newReviewText);
echo "<div style='margin-top: 20px; text-align: center;'>";
echo "Количество гласных букв в блоках 'Обо мне' и 'Отзыв о курсе': " . $vowelCount;
echo "</div>";

$wordCount = countWordsInBlocks($newText, $newReviewText);
echo "<div style='margin-top: 20px; text-align: center;'>";
